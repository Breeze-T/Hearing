...
function recover() {
    debugger
    layer.confirm("确认要还原数据到最近一次的备份吗?", {
        btn: ['确定', '取消']
        // 按钮
    }, function () {
        $.ajax({
...
function toExcel(id,name) {
    ...
    debugger
    var param={ operation: $("#searchOperation").val(),
